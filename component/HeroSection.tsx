          ...
          <div className="flex flex-col-reverse lg:flex-row gap-5 lg:gap-16 items-center">
            ...
            <div className="space-y-8 ">
              <div className="space-y-6">
                <h1 className="text-5xl lg:text-6xl font-bold text-black leading-tight">Lorem ipsum dolor sit amet</h1>
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  ...
                  <Button className="h-12 px-8 bg-[#1959AC] hover:bg-blue-700 text-white">Submit →</Button>
                </div>
