      ...
      <div className="mx-auto    max-w-7xl ">
        <div className="grid grid-cols-1 bg-gray-50 items-start gap-16 lg:grid-cols-2 py-30">
          ...
          <div className="space-y-8 relative">
            ...
            <div>
                <img className="hidden lg:absolute z-40 left-7 lg:left-104" src="https://res.cloudinary.com/diez3alve/image/upload/v1750487173/icons8-push-pin-100_1_i4kvqb.png" alt="" />
            </div>
            {/* Info Card */}
